# Recurly Client for Go
 ...
 [![Build Status](https://travis-ci.org/blacklightcms/recurly.svg?branch=master)](https://travis-ci.org/blacklightcms/recurly)  [![GoDoc](https://godoc.org/github.com/fubotv/go-recurly?status.svg)](https://godoc.org/github.com/fubotv/go-recurly/)
...
```shell
go get github.com/fubotv/go-recurly
```

Import:
```go
import "github.com/fubotv/go-recurly"
```

Resources:
 - [API Docs](https://godoc.org/github.com/fubotv/go-recurly/)
 - [Examples](https://godoc.org/github.com/fubotv/go-recurly/#pkg-examples)

## Note on v1 and breaking changes
If migrating from a previous version of the library, there was a large refactor with breaking changes released to address some design issues with the library. See the [migration guide](https://github.com/fubotv/go-recurly/wiki/v1-Migration-Guide) for steps on how to migrate to the latest version.
...
## Examples and How To
Please go through [examples](https://godoc.org/github.com/fubotv/go-recurly/#pkg-examples) for detailed examples of using this package.
...
```go
// import "github.com/fubotv/go-recurly/webhooks"
...
For examples of how to test your code using mocks, visit the [GoDoc examples](https://godoc.org/github.com/fubotv/go-recurly/mock/).
